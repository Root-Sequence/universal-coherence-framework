...
**Audit status, updated 2026-09-24:** incomplete. This directory contains domain literature, proposed mappings, and interpretations. It is not a certified empirical foundation for UCF. The earlier claims that this layer was complete, purely empirical, or demonstrated universality are withdrawn from this index; the [original index](../archive/foundations-index-before-2026-09-16.md) is preserved.
...
- [Coherence and systems theory](coherence-and-systems-theory.md): **high-priority re-audit.** Its older wording presents a cross-domain definition, generalized attractor categories, and multi-level necessity claims more strongly than the current evidence convention permits. Treat it as historical exploratory synthesis until rewritten against scoped sources.
...
- [Ecological resilience](ecological-stability-and-resilience.md) and [organizational resilience](resilience-engineering-and-organizational-coherence.md): domain evidence and applicability require separate review. The [2026-09-24 evidence reconciliation](../dynamic-coherence-evidence-audit-2026-09-24.md) confirms that ecological resilience, adaptability, and transformability should not be collapsed into one cross-domain coherence ranking.
